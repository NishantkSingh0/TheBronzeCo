...
import VivahCollection from "./VivahCollection";
import GrihaPraveshCollection from "./GrihaPraveshCollection";
import GiftsThatLastCollection from "./GiftsThatLastCollection";
import DhanterasDiwaliCollection from "./Dhanteras&DiwaliCollection";
import DailyRitualCollection from "./DailyRitualCollection";
...
const collections = [
  {
    ...
    description:
      "Sacred kansa pieces crafted for weddings, shagun and the rituals that begin a new chapter.",
    accent: "Wedding & Shagun",
  },
  {
    id: "grihapravesh",
    label: "Collection 02",
    title: "Griha Pravesh",
    subtitle: "Blessings for a new beginning",
    description:
      "Traditional kansa essentials for housewarming ceremonies, first meals and auspicious beginnings.",
    accent: "Housewarming & Rituals",
  },
  {
    id: "gifting",
    label: "Collection 03",
    title: "Gifts That Last",
    subtitle: "A gift with meaning",
    description:
      "Thoughtful kansa gifts made to be remembered, reused and passed down through generations.",
    accent: "Gifting & Keepsakes",
  },
  {
    id: "festive",
    label: "Collection 04",
    title: "Dhanteras & Diwali",
    subtitle: "Light, abundance & tradition",
    description:
      "Festive kansa pieces for puja, prasad, celebrations and the traditions of Diwali.",
    accent: "Festive & Puja",
  },
  {
    id: "everyday",
    label: "Collection 05",
    title: "Daily Rituals",
    subtitle: "Sacred metal, every day",
    description:
      "Everyday kansa essentials designed to bring tradition and mindful living into modern homes.",
...
const CollectionIllustration = ({ id }) => {
  const map = {
    ...
    grihapravesh: (
      ...
      >
        <path
          d="M50 90 L42 50 Q38 30 60 24 Q82 30 78 50 L70 90Z"
          stroke="currentColor"
          strokeWidth="1.5"
        />
        <line
    ...
    gifting: (
      ...
      >
        ...
        />
        <path
          d="M60 44 C60 44 48 36 48 28 C48 20 60 18 60 28 C60 18 72 20 72 28 C72 36 60 44 60 44Z"
          stroke="currentColor"
          strokeWidth="1.5"
        />
      </svg>
    ...
    festive: (
      ...
      >
        <path
          d="M30 75 Q40 55 60 50 Q80 55 90 75 Q70 85 60 85 Q50 85 30 75Z"
          stroke="currentColor"
          strokeWidth="1.5"
        />
        <path
          d="M60 50 C55 38 52 28 60 20 C68 28 65 38 60 50Z"
          stroke="currentColor"
          strokeWidth="1.5"
        />
        <line
    ...
    everyday: (
      ...
      >
        <path
          d="M45 30 L40 90 L80 90 L75 30Z"
          stroke="currentColor"
          strokeWidth="1.5"
        />
        <line
...
export default function Collections() {
  ...
  if (selectedCollection) {
    const collectionComponents = {
      vivaah: VivahCollection,
      grihapravesh: GrihaPraveshCollection,
      gifting: GiftsThatLastCollection,
      festive: DhanterasDiwaliCollection,
      everyday: DailyRitualCollection,
    };

    const SelectedComponent =
      collectionComponents[selectedCollection.id];
  ...
  return (
    <section
      id="collections"
      className="py-24 px-6 bg-brown-900"
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16 reveal">
          ...
          <p className="section-label text-brown-300 mb-4">
            Our Collections
          </p>
          ...
          <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl font-light text-cream-100 leading-tight">
            ...
            <span className="italic text-brown-300">
              One Sacred Metal.
            </span>
          </h2>
          ...
          <p className="font-sans text-cream-400/70 text-sm max-w-xl mx-auto leading-relaxed font-light">
            From the wedding thali to the morning ritual glass —
            each collection is built around the moments that matter
            most in Indian life.
          </p>
        </div>
